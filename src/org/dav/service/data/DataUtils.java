...
public class DataUtils
{
	...
	public static File getFileWithCurrentTimeInName(File file, String dateTimePattern)
	{
		if (file == null)
			return null;
		...
		String timeString = time.format(DateTimeFormatter.ofPattern(dateTimePattern));
